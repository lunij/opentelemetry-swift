...
class RawCounterMetricSdkBase<T>: RawCounterMetric {
    ...
    func record(sum _: T, startDate _: Date, endDate _: Date, labels _: [String: String]) {
        // noop
    }

    func record(sum _: T, startDate _: Date, endDate _: Date, labelset _: LabelSet) {
        // noop
    }
    ...
    func createMetric(recordStatus _: RecordStatus) -> BoundRawCounterMetricSdkBase<T> {
        // noop
        fatalError()
    }
}
