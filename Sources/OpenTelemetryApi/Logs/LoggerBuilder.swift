...
public protocol LoggerBuilder {
    ...
    /// The event domain will be included in the event.domain attribute for every event produced by the resulting Logger.
    ///
    ...
    /// - Returns: self
    func setEventDomain(_ eventDomain: String) -> LoggerBuilder
    ...
    /// - Returns: self
    func setSchemaUrl(_ schemaUrl: String) -> LoggerBuilder
    ...
    /// - Returns: self
    func setInstrumentationVersion(_ instrumentationVersion: String) -> LoggerBuilder
    ...
    /// - Returns: self
    func setIncludeTraceContext(_ includeTraceContext: Bool) -> LoggerBuilder
    ...
    /// - Returns: self
    func setAttributes(_ attributes: [String: AttributeValue]) -> LoggerBuilder
