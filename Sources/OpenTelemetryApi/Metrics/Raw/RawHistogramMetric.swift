...
public struct NoopRawHistogramMetric<T>: RawHistogramMetric {
    public func record(explicitBoundaries _: [T], counts _: [Int], startDate _: Date, endDate _: Date, count _: Int, sum _: T, labelset _: LabelSet) {}

    public func record(explicitBoundaries _: [T], counts _: [Int], startDate _: Date, endDate _: Date, count _: Int, sum _: T, labels _: [String: String]) {}

    public init() {}

    public func bind(labelset _: LabelSet) -> BoundRawHistogramMetric<T> {
        BoundRawHistogramMetric<T>()
    }

    public func bind(labels _: [String: String]) -> BoundRawHistogramMetric<T> {
        BoundRawHistogramMetric<T>()
    }
}
