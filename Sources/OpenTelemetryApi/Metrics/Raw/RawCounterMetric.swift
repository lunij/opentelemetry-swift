...
public struct NoopRawCounterMetric<T>: RawCounterMetric {
    public func record(sum _: T, startDate _: Date, endDate _: Date, labels _: [String: String]) {}

    public func record(sum _: T, startDate _: Date, endDate _: Date, labelset _: LabelSet) {}

    public func bind(labelset _: LabelSet) -> BoundRawCounterMetric<T> {
        BoundRawCounterMetric<T>()
    }

    public func bind(labels _: [String: String]) -> BoundRawCounterMetric<T> {
        BoundRawCounterMetric<T>()
    }
}
