...
extension Tag: TStruct {
    public static var fieldIds: [String: Int32] {
        ["key": 1, "vType": 2, "vStr": 3, "vDouble": 4, "vBool": 5, "vLong": 6, "vBinary": 7]
    }

    public static var structName: String { "Tag" }
...
extension Log: TStruct {
    public static var fieldIds: [String: Int32] {
        ["timestamp": 1, "fields": 2]
    }

    public static var structName: String { "Log" }
...
extension SpanRef: TStruct {
    public static var fieldIds: [String: Int32] {
        ["refType": 1, "traceIdLow": 2, "traceIdHigh": 3, "spanId": 4]
    }

    public static var structName: String { "SpanRef" }
...
extension Span: TStruct {
    public static var fieldIds: [String: Int32] {
        ["traceIdLow": 1, "traceIdHigh": 2, "spanId": 3, "parentSpanId": 4, "operationName": 5, "references": 6, "flags": 7, "startTime": 8, "duration": 9, "tags": 10, "logs": 11]
    }

    public static var structName: String { "Span" }
...
extension Process: TStruct {
    public static var fieldIds: [String: Int32] {
        ["serviceName": 1, "tags": 2]
    }

    public static var structName: String { "Process" }
...
extension Batch: TStruct {
    ...
    public static var structName: String { "Batch" }
...
extension BatchSubmitResponse: TStruct {
    ...
    public static var structName: String { "BatchSubmitResponse" }
...
extension Collector_submitBatches_args: TStruct {
    ...
    fileprivate static var structName: String { "Collector_submitBatches_args" }
...
extension Collector_submitBatches_result: TStruct {
    ...
    fileprivate static var structName: String { "Collector_submitBatches_result" }
