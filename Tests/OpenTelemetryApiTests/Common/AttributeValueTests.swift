...
class AttributeValueTest: XCTestCase {
    func testAttributeValue_EqualsAndHashCode() {
        ...
        XCTAssertNotEqual(AttributeValue.string("MyStringAttributeValue"), AttributeValue.int(123_456))
        ...
        XCTAssertNotEqual(AttributeValue.string("MyStringAttributeValue"), AttributeValue.intArray([123_456, 123_456]))
        ...
        XCTAssertNotEqual(AttributeValue.bool(true), AttributeValue.int(123_456))
        ...
        XCTAssertNotEqual(AttributeValue.bool(true), AttributeValue.intArray([123_456, 123_456]))
        XCTAssertNotEqual(AttributeValue.bool(true), AttributeValue.doubleArray([1.23456, 1.23456]))
        XCTAssertEqual(AttributeValue.int(123_456), AttributeValue.int(123_456))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.int(1_234_567))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.double(1.23456))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.stringArray(["MyStringAttributeValue", "MyStringAttributeValue"]))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.boolArray([true, true]))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.intArray([123_456, 123_456]))
        XCTAssertNotEqual(AttributeValue.int(123_456), AttributeValue.doubleArray([1.23456, 1.23456]))
        ...
        XCTAssertNotEqual(AttributeValue.double(1.23456), AttributeValue.intArray([123_456, 123_456]))
        ...
        XCTAssertNotEqual(AttributeValue.stringArray(["MyStringAttributeValue", "MyStringAttributeValue"]), AttributeValue.intArray([123_456, 123_456]))
        ...
        XCTAssertNotEqual(AttributeValue.boolArray([true, true]), AttributeValue.intArray([123_456, 123_456]))
        XCTAssertNotEqual(AttributeValue.boolArray([true, true]), AttributeValue.doubleArray([1.23456, 1.23456]))
        XCTAssertEqual(AttributeValue.intArray([123_456, 123_456]), AttributeValue.intArray([123_456, 123_456]))

        XCTAssertNotEqual(AttributeValue.intArray([123_456, 123_456]), AttributeValue.intArray([123_457, 123_456]))
        XCTAssertNotEqual(AttributeValue.intArray([123_456, 123_456]), AttributeValue.doubleArray([1.23456, 1.23456]))
    ...
    func testAttributeValue_Tostring() {
        ...
        attribute = AttributeValue.int(123_456)
    ...
    func testAttributeValue_ExplicitCodableForwardCompatibility() throws {
        ...
        attribute = AttributeValueExplicitCodable(attributeValue: AttributeValue.int(123_456))
        decodedAttribute = try decoder.decode(AttributeValue.self, from: try encoder.encode(attribute))
        XCTAssertEqual(attribute.attributeValue, decodedAttribute)
